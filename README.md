...
choose the thread number the number of cores in your cpu. More threads require more ram , if you run you run into oom (program crash try with lower number of threads.
